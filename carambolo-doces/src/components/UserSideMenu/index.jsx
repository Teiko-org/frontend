    ...
    <div className={`w-[450px] px-10 bg-bgHome border-r-2 border-r-gold`}>
      ...
      <div className="flex flex-col items-center gap-10 mb-10">
        ...
        <div className="flex flex-col items-center justify-around mb-6 gap-5">
              <img width={190} src="src/assets/user_icon.png" alt="Ícone de Usuário" />
              <Button text={<span className="flex items-center gap-3 p-1">Enviar Imagem <LuUpload/></span>}/>
        </div>

        
        <div className="flex flex-col gap-3 mb-10">
            <button className="w-[365px] bg-bgNativeHome border-2 border-gold rounded-2xl font-semibold p-3 px-5 text-left">Dados Pessoais</button>
            <button className="w-[365px] bg-bgNativeHome border-2 border-gold rounded-2xl font-semibold p-3 px-5 text-left">Endereços</button>
        </div>
